...
function pfUI:LoadConfig()
  ...
  pfUI:UpdateConfig("appearance", "cd",          "hidetimeunits",    "0")
  ...
  pfUI:UpdateConfig("chat",       "text",        "blacklist",        "")
  ...
  pfUI:UpdateConfig("nameplates", nil,           "showplayerinfo",   "0")
  pfUI:UpdateConfig("nameplates", nil,           "markquests",       "0")
  ...
  pfUI:UpdateConfig("nameplates", nil,           "limithealth",      "150")
