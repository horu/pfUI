pfUI:RegisterModule("gui", "vanilla:tbc", function ()
  ...
  do -- Generate Config UI
    ...
    CreateGUIEntry(T["Settings"], T["General"], function()
      ...
      CreateConfig(nil, T["Unit Name Font"], C.global, "font_unit_name", "dropdown", pfUI.gui.dropdowns.fonts)
    ...
    CreateGUIEntry(T["Settings"], T["Cooldown"], function()
      ...
      CreateConfig(nil, T["Hide Time Units ( m, h, d )"], C.appearance.cd, "hidetimeunits", "checkbox")
    end)
    ...
    CreateGUIEntry(T["Panel"], nil, function()
      ...
      CreateConfig(nil, T["Left Panel: Width"], C.panel.left, "width")
      ...
      CreateConfig(nil, T["Right Panel: Width"], C.panel.right, "width")
    ...
    CreateGUIEntry(T["Nameplates"], nil, function()
      ...
      CreateConfig(U["nameplates"], T["Show Player Status"], C.nameplates, "showplayerinfo", "checkbox")
      CreateConfig(U["nameplates"], T["Mark Quest Creatures (require pfQuest)"], C.nameplates, "markquests", "checkbox")
      CreateConfig(U["nameplates"], T["Show Guild Name"], C.nameplates, "showguildname", "checkbox")
      CreateConfig(U["nameplates"], T["Nameplate Vertical Offset"], C.nameplates, "offset")
      CreateConfig(U["nameplates"], T["Show Additional Npc Info(Trainers and etc.)"], C.nameplates, "shownpcinfo", "checkbox")
      CreateConfig(U["nameplates"], T["Additional Npc Info/Guild Name Offset"], C.nameplates, "additionaloffset")
      ...
      CreateConfig(U["nameplates"], T["Healthbar Count Limit On Screen"], C.nameplates, "limithealth")
